...
// center vert
message = message + "<div style='margin:0px;padding:30px;width:100%;background:#3b0000;color:#fff'>";
...
// Feel free to change the address of the I disagree redirection to either a non-cookie site or a Google or the ICO web site
    message = message + "<br /><INPUT TYPE='button' class='btn btn-success' VALUE='I Agree' onClick='JavaScript:doAccept();' /> <INPUT TYPE='button' class='btn btn-warning' VALUE=\"I don't agree\" onClick='JavaScript:doNotAccept("
